...
float4 SourceRGBA_1 = tex2D(_MainTex, SpriteSheetAnimationUV_1);
float4 _ColorHSV_1 = ColorHSV(SourceRGBA_1,_ColorHSV_Hue_1,_ColorHSV_Saturation_1,_ColorHSV_Brightness_1);
