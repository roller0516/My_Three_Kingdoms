...
namespace VoxelBusters.NativePlugins
{
	...
	public class NPSettings : SharedScriptableObject<NPSettings>, IAssetStoreProduct
	{
        ...
        public 	    const 	string 		kProductVersion					= "1.5.7p5 (>=2019.3)";
		...
		// Macro actions
		#if UNITY_EDITOR
		private 	readonly char[] 	defineSeperators 				= {
			';',
			',',
			' '
		};	
...
//		}
		...
		private void WriteAndroidManifestFile()
		{
			...
			if (AssetDatabaseUtils.FolderExists(_manifestFolderPath))
			{
				...
				_generator.SaveManifest("com.voxelbusters.androidnativeplugin", _manifestFolderPath + "/AndroidManifest.xml", "14", "28");
				#else
