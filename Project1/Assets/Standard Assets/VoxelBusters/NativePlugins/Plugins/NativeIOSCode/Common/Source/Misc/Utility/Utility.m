...
+ (UIImage*)GetImage:(NSString*)imageName withExtension:(NSString*)extenstion //Loads from its contained bundle where this class exists too
{
    NSBundle * bundle       = [NSBundle bundleForClass:[self class]];
    NSString *resourcePath  = [bundle pathForResource:imageName ofType:extenstion];
